...
public class RedisUtil {
     ...
     * @param timeUnit 时间颗粒度
     */
    public <T> void setNX(final String key, final T value, final Integer timeout, final TimeUnit timeUnit) {
     ...
     * @return 缓存的对象
     */
    public <T> long lSet(final String key, final List<T> dataList) {
     ...
     * @param dataMap
     */
    public <T> void hSet(final String key, final Map<String, T> dataMap) {
        if (dataMap != null) {
     ...
     * @return
     */
    public <T> Map<String, T> hGet(final String key) {
